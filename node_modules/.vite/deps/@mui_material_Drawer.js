...
var Slide = React13.forwardRef(function Slide2(props, ref) {
  const theme = useTheme();
  const defaultEasing = {
  ...
  const childrenRef = React13.useRef(null);
...
true ? Slide.propTypes = {
   ...
   */
  container: chainPropTypes(import_prop_types12.default.oneOfType([HTMLElementType, import_prop_types12.default.func]), (props) => {
    if (props.open) {
...
var Drawer = React15.forwardRef(function Drawer2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiDrawer"
  });
  ...
  const drawer = (0, import_jsx_runtime8.jsx)(DrawerPaper, {
  ...
  if (variant === "permanent") {
    return (0, import_jsx_runtime8.jsx)(DrawerDockedRoot, {
  ...
  const slidingDrawer = (0, import_jsx_runtime8.jsx)(TransitionComponent, {
    in: open,
  ...
  return (0, import_jsx_runtime8.jsx)(DrawerRoot, {
    BackdropProps: {
      ...BackdropProps,
      ...BackdropPropsProp,
      transitionDuration
...
true ? Drawer.propTypes = {
   ...
   * @default 'left'
   */
  anchor: import_prop_types14.default.oneOf(["bottom", "left", "right", "top"]),
  /**
   * @ignore
   */
   ...
   * @default {}
   */
  ModalProps: import_prop_types14.default.object,
  /**
   * Callback fired when the component requests to be closed.
   * The `reason` parameter can optionally be used to control the response to `onClose`.
   *
   ...
   */
  SlideProps: import_prop_types14.default.object,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
   ...
   * @default 'temporary'
   */
  variant: import_prop_types14.default.oneOf(["permanent", "persistent", "temporary"])
} : void 0;
